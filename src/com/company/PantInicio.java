...
public class PantInicio extends Application {
    ...
    static File puntaj = new File("puntajes.txt");

    static Integer score=10;
    ...
    public void start(Stage primaryStage){
        File file = new File("/Users/samuelarturogarridosanchez/Desktop/General/Últimos proyectos/SpaceWar/src/com/company/moon.mp3");
        ...
        try {
            ...
            grid.add((AnchorPane)FXMLLoader.load(getClass().getResource("Puntajes.fxml")));
